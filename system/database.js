module.exports = (m) => {
   ...
   if (setting) {
      ...
      if (!('sk_pack' in setting)) setting.sk_pack = 'R-BOT'
      if (!('sk_author' in setting)) setting.sk_author = '@whatsapp'
      ...
      if (!('owners' in setting)) setting.owners = ['6282142108243']
      ...
      if (!('cover' in setting)) setting.cover = 'https://telegra.ph/file/f72f4916858424fb0adf1.jpg'
      if (!('link' in setting)) setting.link = 'https://chat.whatsapp.com/Bd2mN13f4QV7Mu1vtZ0NuP'
   } else {
      global.db.setting = {
         autodownload: true,
         chatbot: true,
         ...
         online: true,
         onlyprefix: '+',
         owners: ['6282142108243'],
         lastReset: new Date * 1,
         msg: 'Hi +tag 🪸\nI am an automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version\n◦ *Source* : https://github.com/neoxr/neoxr-bot\n\nIf you find an error or want to upgrade premium plan contact the owner.',
         menuStyle: 4,
         cover: 'https://telegra.ph/file/f72f4916858424fb0adf1.jpg',
         link: 'https://chat.whatsapp.com/Bd2mN13f4QV7Mu1vtZ0NuP'
      }
   }
}